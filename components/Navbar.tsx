  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/contact">
                <button className="hidden md:flex items-center px-6 py-2.5 bg-primary text-white font-medium rounded-lg  transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                  Get Quote
                </button>
              </Link>
      ...
      <div className="lg:hidden fixed bottom-6 right-6 z-50">
        <Link href="/contact">
          <button className="flex items-center px-6 py-3 bg-primary text-white font-semibold rounded-full shadow-2xl hover:bg-blue-700 transform hover:scale-105 transition-all duration-200">
            Get Quote
          </button>
        </Link>
      </div>
